...
const Contatti: React.FC = () => {
  return (
    <>
      <Container id="container-contatti">
        <Row>
          <Col xs={12} className="col-info-contatti">
            <div className="d-flex flex-column justify-content-center align-items-center gap-4 p-5">
              <div id="div-number-phone">
                <svg
                ...
                <h3 className="info-contatti">+39 3349963080</h3>
              </div>
              <div id="div-email">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                ...
                <h3 className="info-contatti">cloudpost10@gmail.com</h3>
              </div>
              <div id="div-instagram">
                ...
                <Link
                  to={"https://www.instagram.com/claudio_postiglione99/"}
                  target="blank"
                  id="title-instagram"
                >
              ...
              <div id="div-github">
                ...
                <Link
                  to={"https://github.com/Claudio9905"}
                  target="blank"
                  id="title-github"
                >
                  Claudio9905
